...
#[derive(Debug)]
pub struct FutureEventProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FutureEventProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FutureEvent processing");
    
    let mut processor = FutureEventProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FutureEventProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FutureEventProcessor::new(false);
